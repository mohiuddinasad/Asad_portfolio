...
@section('backend_content')
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('dashboard.service.service.update', $service->id) }}" method="post"
                    ...
                    <div class="row">
                        <div class="mb-3 col-lg-6">
                            ...
                            <input value="{{ $service->title }}" type="text" class="form-control" id="title" name="title"
                                required>
                        </div>
                        <div class="mb-3 col-lg-6">
                            <label for="slug" class="form-label">Slug</label>
                            <input value="{{ $service->slug }}" type="text" class="form-control" id="slug" name="slug"
                                required>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="short_description" name="short_description" rows="3">{{ $service->short_description }}</textarea>
                    </div>
                    <div class="mb-3">
