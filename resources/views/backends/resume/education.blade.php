...
@section('backend_content')
                                    ...
                                    @forelse($educations as $education)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('dashboard.resume.education.delete', $education->id) }}"
    ...
    <div class="modal fade" id="addModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('dashboard.resume.education.store') }}" method="POST">
                    @csrf
    ...
    <script>
        function editEducation(id, title, duration, description) {
            document.getElementById('editForm').action = `/dashboard/resume/education/update/${id}`;
