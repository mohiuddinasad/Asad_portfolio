...
<body class="index-page">
        ...
        <div class="container container-xl position-relative d-flex align-items-center justify-content-between">
            ...
            <nav id="navmenu" class="navmenu">
                <ul>
                    ...
                    <li><a href="{{ route('frontend.projects.all') }}"
                            class="{{ request()->routeIs('frontend.projects.all') ? 'active' : '' }}">Project</a></li>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasExampleLabel"><img src="{{ asset($logo) }}" alt=""></h5>
        ...
        <div class="offcanvas-body">
            ...
            <ul class="nav-links p-0" style="list-style: none;">
                <li>
                    ...
                    <a href="{{ route('home') }}" class="nav-link {{ request()->routeIs('home') ? 'active' : '' }}"><span class="me-2 lh-1"><iconify-icon
                                icon="ic:round-home" width="24" height="24"></iconify-icon></span>Home</a>
                </li>
                <li><a href="{{ route('frontend.about') }}" class="nav-link {{ request()->routeIs('frontend.about') ? 'active' : '' }}"> <span class="me-2 lh-1"><iconify-icon
                                icon="qlementine-icons:user-16" width="24" height="24"></iconify-icon></span>
                        About</a>
                </li>

                <li><a href="{{ route('frontend.services') }}" class="nav-link {{ request()->routeIs('frontend.services') ? 'active' : '' }}"> <span class="me-2 lh-1"><iconify-icon
                                icon="ic:round-home-repair-service" width="24" height="24"></iconify-icon></span>
                        Services</a></li>
                <li><a href="{{ route('frontend.projects.all') }}" class="nav-link {{ request()->routeIs('frontend.projects.all') ? 'active' : '' }}"> <span
                            class="me-2 lh-1"><iconify-icon icon="eos-icons:project" width="24"
                                height="24"></iconify-icon></span> Project</a></li>
                <li><a href="{{ route('frontend.contact') }}" class="nav-link {{ request()->routeIs('frontend.contact') ? 'active' : '' }}"> <span class="me-2 lh-1"><iconify-icon
                                icon="hugeicons:contact-02" width="24" height="24"></iconify-icon></span>
                        Contact</a>
                </li>
            </ul>
        ...
        <div class="container text-center">
            ...
            <div class="link">
                @foreach ($socialLinks as $social)
                    <a href="{{ $social->url }}" target="_blank"><iconify-icon icon="{{ $social->icon }}"
            ...
            <div class="contact d-flex align-items-center justify-content-center">
                ...
                <div class="phone">
                    <a href="tel:{{ $user->phone }}"><span>
                            <iconify-icon icon="mingcute:phone-line" width="24"
